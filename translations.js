// Модуль переводов для астрологического сайта
export const translations = {
    uk: {
        ...
        'service-2-btn': '🎓 Записатися на курс',
        ...
        'footer-astrology': 'Астрологія доступна кожному!',
        'footer-copyright': '© 2025 🌟 Оксана Семенович.',
    ...
    en: {
        ...
        'footer-astrology': 'Astrology is accessible to everyone!',
        'footer-copyright': '© 2025 🌟 Oksana Semenovich.',
    ...
    pl: {
        ...
        'footer-astrology': 'Astrologia dostępna dla każdego!',
        'footer-copyright': '© 2025 🌟 Oksana Semenovich.',
    ...
    ru: {
        ...
        'service-1-title': '🌟 Личная консультация с астрологом',
        'service-1-desc': 'Это не просто разбор гороскопа. Это глубокий анализ вашей души, ваших талантов и вашего предназначения. После нашей встречи вы будете знать, в каком направлении двигаться, чтобы жить той жизнью, о которой мечтаете.',
        'service-1-price': '🌟 от 50€',
        'service-1-btn': '🌟 Записаться',
        'service-2-title': '🎓 Курс "Я-астролог"',
        'service-2-desc': 'Хотите не только понимать свою судьбу, но и помогать другим людям? Мой уникальный курс "Я-астролог" - это не просто теория. Это практические навыки, которые позволят вам зарабатывать, помогая людям. Даже те, кто уже пробовал учиться астрологии в других местах, говорят: "Наконец-то все встало на свои места!"',
        'service-2-price': '🎓 Подробности на сайте',
        'service-2-btn': '🎓 Записаться на курс',
        'service-3-title': '📊 Астропрогнозы',
        'service-3-desc': 'Ежемесячные астропрогнозы, которые сбываются с поразительной точностью! Подписывайтесь на мой YouTube-канал "Астрология доступна каждому!" и получайте полезную информацию первыми.',
        'service-3-price': '📊 Бесплатно',
        'service-3-btn': '📺 Посмотреть',

        // About
        'about-title': '🔮 Почему стоит доверять именно мне?',
        'about-desc-1': 'За 15+ лет практики я помогла сотням людей изменить свою жизнь. Мои прогнозы сбываются с точностью 85% - не потому что я "гадаю", а потому что я вижу реальные закономерности в звездах. На моем YouTube-канале "Астрология доступна каждому!" уже более 50,000 подписчиков, которые ежемесячно получают точные прогнозы.',
        'about-desc-2': 'Я не теоретик - я практик. Мой курс "Я-астролог" создали для тех, кто хочет не просто изучать астрологию, а применять ее в реальной жизни. Даже опытные астрологи говорят: "Наконец-то я понимаю, как это работает на практике!" Каждая моя консультация - это не просто разговор, это настоящий прорыв в понимании себя.',
        ...
        'contact-submit': '🌟 Раскрыть свое предназначение',
        ...
        // Footer
        'footer-name': '🌟 Оксана Семенович',
        'footer-desc': '🌟 Ведический астролог-прогнозист. Раскройте тайны вашей души и найдите свое истинное предназначение',
        'footer-contacts': '🌟 Контакты',
        'footer-social': '🌟 Социальные сети',
        'footer-rights': '🌟 Все права защищены космическим законом',
        'footer-astrology': 'Астрология доступна каждому!',
        'footer-copyright': '© 2025 🌟 Оксана Семенович.',

        // Modal
        'modal-title': '🌟 Ваше предназначение раскрыто!',
