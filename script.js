...
const translations = {
    uk: {
        ...
        // Star Map
        'star-map-title': '🌟 Інтерактивна карта зоряного неба',
        'star-map-desc': 'Натисніть на зірки для магічного прогнозу!',
                'constellation-select': 'Оберіть сузір\'я',
        'constellation-default': 'Ваше майбутнє буде яскравим!',

        // Tarot Cards
        'tarot-title': '🔮 Інтерактивні карти Таро',
        'tarot-desc': 'Виберіть карту та отримайте персональне передбачення!',
        'tarot-shuffle': 'Перетасувати карти',

        // Zodiac Wheel
        'zodiac-title': '🌟 Інтерактивний Зодіак',
        'zodiac-desc': 'Оберіть свій знак зодіаку та отримайте персональний прогноз!',
    ...
    en: {
        ...
        // Star Map
        'star-map-title': '🌟 Interactive Star Map',
        'star-map-desc': 'Click on stars for magical predictions!',
                'constellation-select': 'Choose a constellation',
        'constellation-default': 'Your future will be bright!',

        // Tarot Cards
        'tarot-title': '🔮 Interactive Tarot Cards',
        'tarot-desc': 'Choose a card and get a personal prediction!',
        'tarot-shuffle': 'Shuffle Cards',

        // Zodiac Wheel
        'zodiac-title': '🌟 Interactive Zodiac',
        'zodiac-desc': 'Choose your zodiac sign and get a personal prediction!',
    ...
    pl: {
        ...
        // Star Map
        'star-map-title': '🌟 Interaktywna mapa gwiazd',
        'star-map-desc': 'Kliknij na gwiazdy po magiczne przewidywania!',
                'constellation-select': 'Wybierz konstelację',
        'constellation-default': 'Twoja przyszłość będzie jasna!',

        // Tarot Cards
        'tarot-title': '🔮 Interaktywne karty Tarota',
        'tarot-desc': 'Wybierz kartę i otrzymaj osobistą wróżbę!',
        'tarot-shuffle': 'Przetasuj karty',

        // Zodiac Wheel
        'zodiac-title': '🌟 Interaktywny Zodiak',
        'zodiac-desc': 'Wybierz swój znak zodiaku i otrzymaj osobistą wróżbę!',
    ...
    ru: {
        ...
        'hero-motto': '✨ Четко. Точно. Логично. Полезно.',
        'hero-description': 'Чувствовали ли вы, что что-то большее ждет вас? Готовы ли вы открыть свое истинное предназначение? Я помогу вам найти ответы, которые изменят вашу жизнь навсегда.',
        'hero-btn-primary': '🌟 Записаться на консультацию (50€)',
        'hero-btn-secondary': '🔮 Бесплатные астрологические прогнозы на YouTube',

        // Services
        'services-title': '🔮 Мои услуги',
        'service-1-title': '🌟 Персональная консультация',
        'service-1-desc': 'Представьте себе, что вы наконец понимаете, зачем вы здесь и что вам делать. Я раскрою тайны вашей натальной карты и покажу путь к вашему высшему потенциалу.',
        'service-1-price': '🌟 от 50€',
        'service-2-title': '🎓 Курс \'Я-астролог\'',
        'service-2-desc': 'Готовы ли вы стать астрологом? Мой курс по ведической астрологии высоко оценили даже те, кто уже учился в других школах астрологии. Раскройте тайны звезд вместе со мной!',
        'service-2-price': '🎓 Детали на сайте',

        'service-3-title': '📊 Астрологические прогнозы',
        'service-3-desc': 'Ежемесячные астрологические прогнозы, которые сбываются с поразительной точностью! Подписывайтесь на мой YouTube-канал \'Астрология доступна каждому!\' и получайте полезную информацию первыми.',
        'service-3-price': '📊 Бесплатно',

        // Star Map
        'star-map-title': '🌟 Интерактивная карта звездного неба',
        'star-map-desc': 'Нажмите на звезды для магических предсказаний!',
        'constellation-select': 'Выберите созвездие',
        'constellation-default': 'Ваше будущее будет ярким!',

        // Tarot Cards
        'tarot-title': '🔮 Интерактивные карты Таро',
        'tarot-desc': 'Выберите карту и получите персональное предсказание!',
        'tarot-shuffle': 'Перетасовать карты',

        // Zodiac Wheel
        'zodiac-title': '🌟 Интерактивный Зодиак',
        'zodiac-desc': 'Выберите свой знак зодиака и получите персональное предсказание!',

        // About
        'about-title': '🔮 Обо мне - Оксана Семенович',
        'about-desc-1': 'Я не просто астролог - я проводник между мирами. Ведический астролог-прогнозист с многолетним опытом, автор YouTube-канала \'Астрология доступна каждому!\', где ежемесячно публикую доступные, сбывающиеся с поразительной точностью астрологические прогнозы.',
        'about-desc-2': 'На основе своего практического опыта я создала курс по ведической астрологии \'Я-астролог\', который высоко оценили даже те, кто уже учился в других школах астрологии. Каждая консультация - это священное путешествие в глубины вашей души.',
        'credential-1': '🌟 Ведический астролог-прогнозист',
        'credential-2': '🔮 YouTube канал \'Астрология доступна каждому!\'',
        'credential-3': '🎓 Автор курса \'Я-астролог\'',
        'credential-4': '⭐ Астролог-Дева. Четко. Точно. Логично. Полезно.',

        // Contact
        'contact-title': '🌟 Готовы открыть свое предназначение?',
        'contact-name': '🌟 Ваше священное имя',
        'contact-email': '🔮 Ваш магический Email',
        'contact-phone': '💫 Ваш космический телефон',
        'contact-service': '🔮 Выберите свою магию',
        'contact-service-placeholder': '🌟 Выберите магическую услугу',
        'contact-service-1': '🌟 Персональная консультация',
        'contact-service-2': '🎓 Курс \'Я-астролог\'',
        'contact-service-3': '📊 Астрологические прогнозы',
        'contact-message': '✨ Ваше священное послание',
        'contact-message-placeholder': '🌟 Опишите, что вы чувствуете и что хотите изменить в своей жизни...',
        'contact-submit': '🌟 Открыть свое предназначение',
        'contact-sidebar-title': '💫 Свяжитесь со мной',
        'payment-title': '💫 Оплата вашей магии',
        'payment-card': '💳 Космическая карта',
        'payment-info': '🌟 Безопасная оплата через защищенные космические системы',

        // Footer
        'footer-name': '🌟 Оксана Семенович',
        'footer-desc': '🌟 Ведический астролог-прогнозист. Раскройте тайны своей души и найдите свое истинное предназначение',
        'footer-contacts': '🌟 Контакты',
        'footer-social': '🌟 Социальные сети',
        'footer-rights': '🌟 Все права защищены космическим законом',

        // Modal
        'modal-title': '🌟 Ваше предназначение открыто!',
        'modal-message': '🌟 Я свяжусь с вами в ближайшее время, чтобы раскрыть тайны вашей души и показать путь к вашему высшему потенциалу.',
...
function detectBrowserLanguage() {
    ...
    if (shortLang === 'uk') {
        return 'uk'; // Украинский -> украинский
    } else if (shortLang === 'ru') {
        return 'en'; // Русский -> английский
    } else if (shortLang === 'pl') {
        return 'pl'; // Польский -> польский
    } else {
        return 'en'; // По умолчанию английский для остальных языков
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Устанавливаем язык браузера по умолчанию
